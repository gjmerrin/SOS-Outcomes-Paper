...
To investigate the impact of SoS on primary outcomes and protective factors we first have to 1) identify the items that measure each construct and 2) determine whether the items measure the construct consistently across each wave (i.e., show measurement invariance).

We accomplish the first goal by conducting an exploratory factor analysis (EFA) followed by a confirmatory factor analysis (CFA):
...
Unlike the other constructs, which were asked of all students at all waves, the exposure items were only given to Sources of Strength students in waves 2 - 4. Therefore, the EFA and CFA samples only included SoS students. With response options 1 = Yes or 0 = No, 15 items (questions 45-50 on the survey) asked students about their exposure to Sources of Strength related information and activities.
 ...
 9) Which activity have you participated in? Named strengths that help me when Im anxious, angry, or depressed.
 10) Which activity have you participated in? Named strengths that Ive grown stronger in.
...
cat("*Model Fit*")
cat("\n\n")
exp.results$cfas$Active$fits %>% flextable() %>% autofit() %>% knit_print()
cat("\n\n")
cat("*Reliability*")
cat("\n\n")
exp.results$cfas$Active$reliabilities %>% flextable() %>% autofit() %>% knit_print()
cat("\n\n")
...
cat("*Model Fit*")
cat("\n\n")
exp.results$cfas$Passive_No4$fits %>% flextable() %>% autofit() %>% knit_print()
cat("\n\n")
cat("*Reliability*")
cat("\n\n")
exp.results$cfas$Passive_No4$reliabilities %>% flextable() %>% autofit() %>% knit_print()
cat("\n\n")
```
...
cat("*Overall Fit*")
cat("\n\n")
all.mi.fits$Active_Exposure %>% flextable() %>% autofit() %>% knit_print()
cat("\n\n")
cat("*Model Comparison*")
cat("\n\n")
all.mi.comp$Active_Exposure %>% flextable() %>% autofit() %>% knit_print()
cat("\n\n")
```
...
cat("*Overall Fit*")
cat("\n\n")
all.mi.fits$Passive_Exposure %>% flextable() %>% autofit() %>% knit_print()
cat("\n\n")
cat("*Model Comparison*")
cat("\n\n")
all.mi.comp$Passive_Exposure %>% flextable() %>% autofit() %>% knit_print()
cat("\n\n")
```
...
For both the Active and Passive Exposure scales, even as more constraints are placed on the model, the fit indices show good model fit. Additionally, the the chi-square tests are non-significant for Active Exposure which provides additional evidence for measurement invariance. As a whole, these results suggest longitudinal measurement invariance holds and we can examine how change in exposure impacts the outcome and protective factors over time.
...
cat("**Model Fit**")
cat("\n\n")
ncperp.results$cfas$fits %>% flextable() %>% autofit() %>% knit_print()
cat("\n\n")
cat("**Reliabilities**")
cat("\n\n")
ncperp.results$cfas$reliabilities %>% flextable() %>% autofit() %>% knit_print()
cat("\n\n")
cat("**Standardized Factor Loadings**")
cat("\n\n")
ncperp.results$cfas$loadings %>% flextable() %>% autofit() %>% knit_print()
cat("\n\n")
```
...
cat("*Overall Fit*")
cat("\n\n")
all.mi.fits$No_Contact_Perpetration %>% flextable() %>% autofit() %>% knit_print()
cat("\n\n")
cat("*Model Comparison*")
cat("\n\n")
all.mi.comp$No_Contact_Perpetration %>% flextable() %>% autofit() %>% knit_print()
cat("\n\n")
```
...
cat("**Model Fit**")
cat("\n\n")
ncvict.results$cfas$fits %>% flextable() %>% autofit() %>% knit_print()
cat("\n\n")
cat("**Reliabilities**")
cat("\n\n")
ncvict.results$cfas$reliabilities %>% flextable() %>% autofit() %>% knit_print()
cat("\n\n")
cat("**Standardized Factor Loadings**")
cat("\n\n")
ncvict.results$cfas$loadings %>% flextable() %>% autofit() %>% knit_print()
cat("\n\n")
```
...
cat("*Overall Fit*")
cat("\n\n")
all.mi.fits$No_Contact_Victimization %>% flextable() %>% autofit() %>% knit_print()
cat("\n\n")
cat("*Model Comparison*")
cat("\n\n")
all.mi.comp$No_Contact_Victimization %>% flextable() %>% autofit() %>% knit_print()
cat("\n\n")
```
...
cat("**Model Fit**")
cat("\n\n")
conperp.results$cfas$fits %>% flextable() %>% autofit() %>% knit_print()
cat("\n\n")
cat("**Reliabilities**")
cat("\n\n")
conperp.results$cfas$reliabilities %>% flextable() %>% autofit() %>% knit_print()
cat("\n\n")
cat("**Standardized Factor Loadings**")
cat("\n\n")
conperp.results$cfas$loadings %>% flextable() %>% autofit() %>% knit_print()
cat("\n\n")
```
...
cat("*Overall Fit*")
cat("\n\n")
all.mi.fits$Contact_Perpetration %>% flextable() %>% autofit() %>% knit_print()
cat("\n\n")
cat("*Model Comparison*")
cat("\n\n")
all.mi.comp$Contact_Perpetration %>% flextable() %>% autofit() %>% knit_print()
cat("\n\n")
```
...
cat("**Model Fit**")
cat("\n\n")
convict.results$cfas$fits %>% flextable() %>% autofit() %>% knit_print()
cat("\n\n")
cat("**Reliabilities**")
cat("\n\n")
convict.results$cfas$reliabilities %>% flextable() %>% autofit() %>% knit_print()
cat("\n\n")
cat("**Standardized Factor Loadings**")
cat("\n\n")
convict.results$cfas$loadings %>% flextable() %>% autofit() %>% knit_print()
cat("\n\n")
```
...
cat("*Overall Fit*")
cat("\n\n")
all.mi.fits$Contact_Victimization %>% flextable() %>% autofit() %>% knit_print()
cat("\n\n")
cat("*Model Comparison*")
cat("\n\n")
all.mi.comp$Contact_Victimization %>% flextable() %>% autofit() %>% knit_print()
cat("\n\n")
```
...
cat("**Model Fit**")
cat("\n\n")
hncperp.results$cfas$fits %>% flextable() %>% autofit() %>% knit_print()
cat("\n\n")
cat("**Reliabilities**")
cat("\n\n")
hncperp.results$cfas$reliabilities %>% flextable() %>% autofit() %>% knit_print()
cat("\n\n")
cat("**Standardized Factor Loadings**")
cat("\n\n")
hncperp.results$cfas$loadings %>% flextable() %>% autofit() %>% knit_print()
cat("\n\n")
```
...
cat("*Overall Fit*")
cat("\n\n")
all.mi.fits$HNC_Perpetration %>% flextable() %>% autofit() %>% knit_print()
cat("\n\n")
cat("*Model Comparison*")
cat("\n\n")
all.mi.comp$HNC_Perpetration %>% flextable() %>% autofit() %>% knit_print()
cat("\n\n")
```
...
cat("**Model Fit**")
cat("\n\n")
hncvict.results$cfas$fits %>% flextable() %>% autofit() %>% knit_print()
cat("\n\n")
cat("**Reliabilities**")
cat("\n\n")
hncvict.results$cfas$reliabilities %>% flextable() %>% autofit() %>% knit_print()
cat("\n\n")
cat("**Standardized Factor Loadings**")
cat("\n\n")
hncvict.results$cfas$loadings %>% flextable() %>% autofit() %>% knit_print()
cat("\n\n")
```
...
cat("*Overall Fit*")
cat("\n\n")
all.mi.fits$HNC_Victimization %>% flextable() %>% autofit() %>% knit_print()
cat("\n\n")
cat("*Model Comparison*")
cat("\n\n")
all.mi.comp$HNC_Victimization %>% flextable() %>% autofit() %>% knit_print()
cat("\n\n")
```
...
cat("**Model Fit**")
cat("\n\n")
cyber.results$cfas$fits %>% flextable() %>% autofit() %>% knit_print()
cat("\n\n")
cat("**Reliabilities**")
cat("\n\n")
cyber.results$cfas$reliabilities %>% flextable() %>% autofit() %>% knit_print()
cat("\n\n")
cat("**Standardized Factor Loadings**")
cat("\n\n")
cyber.results$cfas$loadings %>% flextable() %>% autofit() %>% knit_print()
cat("\n\n")
```
...
cat("*Overall Fit*")
cat("\n\n")
all.mi.fits$Cybersex_Perpetration %>% flextable() %>% autofit() %>% knit_print()
cat("\n\n")
cat("*Model Comparison*")
cat("\n\n")
all.mi.comp$Cybersex_Perpetration %>% flextable() %>% autofit() %>% knit_print()
cat("\n\n")
```
...
cat("**Model Fit**")
cat("\n\n")
dismiss.results$cfas$fits %>% flextable() %>% autofit() %>% knit_print()
cat("\n\n")
cat("**Reliabilities**")
cat("\n\n")
dismiss.results$cfas$reliabilities %>% flextable() %>% autofit() %>% knit_print()
cat("\n\n")
cat("**Standardized Factor Loadings**")
cat("\n\n")
dismiss.results$cfas$loadings %>% flextable() %>% autofit() %>% knit_print()
cat("\n\n")
```
...
cat("*Overall Fit*")
cat("\n\n")
all.mi.fits$SV_Dismissiveness %>% flextable() %>% autofit() %>% knit_print()
cat("\n\n")
cat("*Model Comparison*")
cat("\n\n")
all.mi.comp$SV_Dismissiveness %>% flextable() %>% autofit() %>% knit_print()
cat("\n\n")
```
...
cat("\n\n")
gwb.results$cfas$One_Factor$fits %>% flextable() %>% autofit() %>% knit_print()
cat("\n\n")
cat("*One factor CFA on each wave excluding item 7*")
cat("\n\n")
gwb.results$cfas$Two_Factor$fits %>% flextable() %>% autofit() %>% knit_print()
cat("\n\n")
```
...
cat("*One factor CFA on each wave including item 7*")
cat("\n\n")
gwb.results$cfas$One_Factor$reliabilities %>% flextable() %>% autofit() %>% knit_print()
cat("\n\n")
cat("*One factor CFA on each wave excluding item 7*")
cat("\n\n")
gwb.results$cfas$Two_Factor$reliabilities %>% flextable() %>% autofit() %>% knit_print()
cat("\n\n")
```
...
cat("*Overall Fit*")
cat("\n\n")
all.mi.fits$General_Well.being %>% flextable() %>% autofit() %>% knit_print()
cat("\n\n")
cat("*Model Comparison*")
cat("\n\n")
all.mi.comp$General_Well.being %>% flextable() %>% autofit() %>% knit_print()
cat("\n\n")
```
...
cat("\n\n")
gha.results$cfas$One_Factor$fits %>% flextable() %>% autofit() %>% knit_print()
cat("\n\n")
cat("*Two factor CFA on each wave*")
cat("\n\n")
gha.results$cfas$Two_Factor$fits %>% flextable() %>% autofit() %>% knit_print()
cat("\n\n")
```
...
cat("*One factor CFA on each wave*")
cat("\n\n")
gha.results$cfas$One_Factor$reliabilities %>% flextable() %>% autofit() %>% knit_print()
cat("\n\n")
cat("*Two factor CFA on each wave*")
cat("\n\n")
gha.results$cfas$Two_Factor$reliabilities %>% flextable() %>% autofit() %>% knit_print()
cat("\n\n")
```
...
cat("**Model Fit**")
cat("\n\n")
shhelpatt.results$cfas$fits %>% flextable() %>% autofit() %>% knit_print()
cat("\n\n")
cat("**Reliabilities**")
cat("\n\n")
shhelpatt.results$cfas$reliabilities %>% flextable() %>% autofit() %>% knit_print()
cat("\n\n")
cat("**Standardized Factor Loadings**")
cat("\n\n")
shhelpatt.results$cfas$loadings %>% flextable() %>% autofit() %>% knit_print()
cat("\n\n")
```
...
cat("*Overall Fit*")
cat("\n\n")
all.mi.fits$SH_Help_Attitudes %>% flextable() %>% autofit() %>% knit_print()
cat("\n\n")
cat("*Model Comparison*")
cat("\n\n")
all.mi.comp$SH_Help_Attitudes %>% flextable() %>% autofit() %>% knit_print()
cat("\n\n")
```
...
cat("**Model Fit**")
cat("\n\n")
shhelpseek.results$cfas$fits %>% flextable() %>% autofit() %>% knit_print()
cat("\n\n")
cat("**Reliabilities**")
cat("\n\n")
shhelpseek.results$cfas$reliabilities %>% flextable() %>% autofit() %>% knit_print()
cat("\n\n")
cat("**Standardized Factor Loadings**")
cat("\n\n")
shhelpseek.results$cfas$loadings %>% flextable() %>% autofit() %>% knit_print()
cat("\n\n")
```
...
cat("*Overall Fit*")
cat("\n\n")
all.mi.fits$SH_Help_Seeking %>% flextable() %>% autofit() %>% knit_print()
cat("\n\n")
cat("*Model Comparison*")
cat("\n\n")
all.mi.comp$SH_Help_Seeking %>% flextable() %>% autofit() %>% knit_print()
cat("\n\n")
```
...
cat("*One factor CFA on each wave*")
cat("\n\n")
hothers.results$cfas$One_Factor$fits %>% flextable() %>% autofit() %>% knit_print()
cat("\n\n")
cat("*Two factor CFA on each wave*")
cat("\n\n")
hothers.results$cfas$Two_Factor$fits %>% flextable() %>% autofit() %>% knit_print()
cat("\n\n")
cat("*One factor CFA with items 1, 2, 4, and 5 on each wave*")
cat("\n\n")
hothers.results$cfas$One_Factor_Adj$fits %>% flextable() %>% autofit() %>% knit_print()
cat("\n\n")
```
...
cat("*One factor CFA on each wave*")
cat("\n\n")
hothers.results$cfas$One_Factor$reliabilities %>% flextable() %>% autofit() %>% knit_print()
cat("\n\n")
cat("*Two factor CFA on each wave*")
cat("\n\n")
hothers.results$cfas$Two_Factor$reliabilities %>% flextable() %>% autofit() %>% knit_print()
cat("\n\n")
cat("*One factor CFA with items 1, 2, 4, and 5 on each wave*")
cat("\n\n")
hothers.results$cfas$One_Factor_Adj$reliabilities %>% flextable() %>% autofit() %>% knit_print()
cat("\n\n")
```
...
cat("**Model Fit**")
cat("\n\n")
staffhelp.results$cfas$One_Factor_Adj$fits %>% flextable() %>% autofit() %>% knit_print()
cat("\n\n")
cat("**Reliabilities**")
cat("\n\n")
staffhelp.results$cfas$One_Factor_Adj$reliabilities %>% flextable() %>% autofit() %>% knit_print()
cat("\n\n")
cat("**Standardized Factor Loadings**")
cat("\n\n")
staffhelp.results$cfas$One_Factor_Adj$loadings %>% flextable() %>% autofit() %>% knit_print()
cat("\n\n")
```
...
```{r staffhelp.mi, eval = FALSE}
cat("*Overall Fit*")
cat("\n\n")
all.mi.fits$Staff_Help_Intent %>% flextable() %>% autofit() %>% knit_print()
cat("\n\n")
cat("*Model Comparison*")
cat("\n\n")
all.mi.comp$Staff_Help_Intent %>% flextable() %>% autofit() %>% knit_print()
cat("\n\n")
```
...
cat("**Model Fit**")
cat("\n\n")
alcoholdrugs.results$cfas$fits %>% flextable() %>% autofit() %>% knit_print()
cat("\n\n")
cat("**Reliabilities**")
cat("\n\n")
alcoholdrugs.results$cfas$reliabilities %>% flextable() %>% autofit() %>% knit_print()
cat("\n\n")
cat("**Standardized Factor Loadings**")
cat("\n\n")
alcoholdrugs.results$cfas$loadings %>% flextable() %>% autofit() %>% knit_print()
cat("\n\n")
```
...
cat("*Overall Fit*")
cat("\n\n")
all.mi.fits$Alcohol_and_Drug %>% flextable() %>% autofit() %>% knit_print()
cat("\n\n")
cat("*Model Comparison*")
cat("\n\n")
all.mi.comp$Alcohol_and_Drug %>% flextable() %>% autofit() %>% knit_print()
cat("\n\n")
```
...
cat("**Model Fit**")
cat("\n\n")
bullying.results$cfas$fits %>% flextable() %>% autofit() %>% knit_print()
cat("\n\n")
cat("**Reliabilities**")
cat("\n\n")
bullying.results$cfas$reliabilities %>% flextable() %>% autofit() %>% knit_print()
cat("\n\n")
cat("**Standardized Factor Loadings**")
cat("\n\n")
bullying.results$cfas$loadings %>% flextable() %>% autofit() %>% knit_print()
cat("\n\n")
```
...
cat("*Overall Fit*")
cat("\n\n")
all.mi.fits$Bullying %>% flextable() %>% autofit() %>% knit_print()
cat("\n\n")
cat("*Model Comparison*")
cat("\n\n")
all.mi.comp$Bullying %>% flextable() %>% autofit() %>% knit_print()
cat("\n\n")
```
...
cat("**Model Fit**")
cat("\n\n")
cyberbully.results$cfas$fits %>% flextable() %>% autofit() %>% knit_print()
cat("\n\n")
cat("**Reliabilities**")
cat("\n\n")
cyberbully.results$cfas$reliabilities %>% flextable() %>% autofit() %>% knit_print()
cat("\n\n")
cat("**Standardized Factor Loadings**")
cat("\n\n")
cyberbully.results$cfas$loadings %>% flextable() %>% autofit() %>% knit_print()
cat("\n\n")
```
...
cat("*Overall Fit*")
cat("\n\n")
all.mi.fits$Cyberbullying %>% flextable() %>% autofit() %>% knit_print()
cat("\n\n")
cat("*Model Comparison*")
cat("\n\n")
all.mi.comp$Cyberbullying %>% flextable() %>% autofit() %>% knit_print()
cat("\n\n")
```
...
Using a 3-point response scale (0 = Never, 1 = Sometimes, 2 = Most of the time), 12 items in survey question 34 asked students, "How much have you felt or acted this way in the past 2 weeks?"
...
cat("*One factor CFA on each wave*")
cat("\n\n")
depanx.results$cfas$One_Factor$fits %>% flextable() %>% autofit() %>% knit_print()
cat("\n\n")
cat("*One factor CFA on each wave excluding item 7*")
cat("\n\n")
depanx.results$cfas$Two_Factor$fits %>% flextable() %>% autofit() %>% knit_print()
cat("\n\n")
```
...
cat("*One factor CFA on each wave including item 7*")
cat("\n\n")
depanx.results$cfas$One_Factor$reliabilities %>% flextable() %>% autofit() %>% knit_print()
cat("\n\n")
cat("*One factor CFA on each wave excluding item 7*")
cat("\n\n")
depanx.results$cfas$Two_Factor$reliabilities %>% flextable() %>% autofit() %>% knit_print()
cat("\n\n")
```
...
```{r depanx.mi, eval = FALSE}
cat("*Overall Fit*")
cat("\n\n")
all.mi.fits$Depression.Anxiety %>% flextable() %>% autofit() %>% knit_print()
cat("\n\n")
cat("*Model Comparison*")
cat("\n\n")
all.mi.comp$Depression.Anxiety %>% flextable() %>% autofit() %>% knit_print()
cat("\n\n")
```
...
cat("**Model Fit**")
cat("\n\n")
peervict.results$cfas$fits %>% flextable() %>% autofit() %>% knit_print()
cat("\n\n")
cat("**Reliabilities**")
cat("\n\n")
peervict.results$cfas$reliabilities %>% flextable() %>% autofit() %>% knit_print()
cat("\n\n")
cat("**Standardized Factor Loadings**")
cat("\n\n")
peervict.results$cfas$loadings %>% flextable() %>% autofit() %>% knit_print()
cat("\n\n")
```
...
cat("*Overall Fit*")
cat("\n\n")
all.mi.fits$Peer_Victimization %>% flextable() %>% autofit() %>% knit_print()
cat("\n\n")
cat("*Model Comparison*")
cat("\n\n")
all.mi.comp$Peer_Victimization %>% flextable() %>% autofit() %>% knit_print()
cat("\n\n")
```
