...
# Objective
# Connect implementation to exposure to SV outcomes
# - Implementation at W1 to exposure (and outcomes?) at W2; Imp at W3 to exposure (outcomes) at W4
# Analysis should be descriptive and inferential
# Table with implementation by school and summary -  is there a way to classify schools as high, medium, low implementers? LCA/LPA; PCA?

# Paper outline:
# Focus on SV outcomes & Trusted Adults, present others in supplemental materials
# Discuss analyses we have already completed: unconditional LGM (overall change over time), Tx only models (treatment effect), moderation models (did Tx work for a particular group)
# Add implementation -> exposure -> outcome models to help contextualize null effects

# Further implementation information: https://drive.google.com/drive/folders/1OF6e76OTnhiCaH2UPrRTzKPzxsnjtqPN

# Implmentation logs for initial trainings:
